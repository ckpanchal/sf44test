 ...
 */
final class Version20220122190601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE colleagues CHANGE created created DATETIME DEFAULT NULL, CHANGE updated updated DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE colleagues CHANGE created created INT NOT NULL, CHANGE updated updated INT NOT NULL');
    }
}
